...
/** Represents the different segments of a tile in the Carcassonne game. Each tile has nine segments: four edges, four corners, and a center. Each segment corresponds to
  * a specific part of the tile:
...
enum TileSegment:
  ...
  /** Returns the set of adjacent segments for the current segment.
    *
    * @return
    *   A Set of TileSegment that are adjacent to a given segment, according to the game's official rules.
    */
...
/** Represents a tile in the game.
  *
  * @param segments
  *   A map representing all the segments of the tile and their types.
  * @param imagePath
  *   The path to the image representing this tile.
  */
case class GameTile(segments: Map[TileSegment, SegmentType], imagePath: String):
  ...
  /** Places a follower on a specific segment of the tile.
    *
    * @param segment
    *   The segment where the follower is to be placed.
    * @param playerId
    *   The ID of the player placing the follower.
    */
  ...
  /** Removes a follower from a specific segment of the tile.
    *
    * @param segment
    *   The segment from which the follower is to be removed.
    */
  ...
  /** Retrieves the current map of followers on the tile.
    *
    * @return
    *   A map where keys are segments and values are player IDs.
    */
  ...
  /** Rotates the tile 90 degrees clockwise.
    *
    * @return
    *   A new GameTile instance with segments rotated clockwise.
    */
  ...
  /** Rotates the tile 90 degrees counter-clockwise.
    *
    * @return
    *   A new GameTile instance with segments rotated counter-clockwise.
    */
...
/** Companion object for GameTile.
  *
  * Provides factory methods for creating GameTile instances and implicit JSON Format for GameTile serialization and deserialization.
  */
object GameTile:
  ...
  /** Creates a random GameTile.
    ...
    *
    * @return
    *   A new GameTile instance with randomly assigned segments and image.
    */
  ...
  /** Creates the starting tile for the game.
    *
    * Generates a predefined tile that is by default used to start the game, according to the game's official rules.
    *
    * @return
    *   A new GameTile instance representing the starting tile.
    */
