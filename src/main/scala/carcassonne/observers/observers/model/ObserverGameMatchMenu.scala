...
/** Trait representing an observer for the game match menu.
  *
  * This trait defines the contract for observing changes in the game match menu, such as tile draws, player changes, available follower positions, and scoreboard
  * updates.
  */
trait ObserverGameMatchMenu:
  ...
  /** Gets the current player.
    *
    * @return
    *   An option containing the current player, or None if no player is set.
    */
  ...
  /** Called to update the scoreboard.
    ...
    *
    * @param scores
    *   A map of players to their respective scores.
    */
