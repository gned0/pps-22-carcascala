 ...
 *
 * This trait defines the contract for observing changes in the game menu view, such as setting the current player,
 * getting and setting the drawn tile, skipping follower placement, and ending the game early.
 */
trait ObserverGameMenuView:
   ...
   *
   * @return An option containing the current player if set, otherwise None.
   */
   ...
   *
   * @return A tuple containing the currently drawn tile and its image view.
   */
   ...
   *
   * @param drawnTile A tuple containing the tile and its image view to be set as the drawn tile.
   */
   ...
   *
   * @param position An optional position where the follower placement is skipped.
   */
